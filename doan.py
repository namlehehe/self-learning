...
while True:
    ...
    #mỗi bức ảnh sẽ đẩy về giá trị của 1 mảng có chiều rông, cao khác nhau
    ...
    #do các bức ảnh 0-5.png khác nhau các giá trị width, height nên phải get theo shape
        ...
        cv2.rectangle(frame,(0,200),(150,400),(69,196,190),-1)
        cv2.putText(frame,str(songontay),(20,350),cv2.FONT_HERSHEY_PLAIN,10,(244,230,221),5)
    ...
    cv2.putText(frame, f"FPS: {int(fps)}",(150,70),cv2.FONT_HERSHEY_PLAIN,3,(244,230,221),3)


    cv2.imshow("BAITAPLON",frame)
